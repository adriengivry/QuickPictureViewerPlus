namespace QuickPictureViewerPlus
{
	partial class SettingsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.settingsTabs = new QuickLibraryPlus.QlibTabs();
			this.themePage = new System.Windows.Forms.TabPage();
			this.restartLabel1 = new System.Windows.Forms.Label();
			this.systemThemeRadio = new QuickLibraryPlus.QlibRadio();
			this.darkThemeRadio = new QuickLibraryPlus.QlibRadio();
			this.lightThemeRadio = new QuickLibraryPlus.QlibRadio();
			this.themeRestart = new System.Windows.Forms.LinkLabel();
			this.mousePage = new System.Windows.Forms.TabPage();
			this.mouseWheelActionRadio3 = new QuickLibraryPlus.QlibRadio();
			this.mouseWheelActionRadio2 = new QuickLibraryPlus.QlibRadio();
			this.mouseWheelActionRadio1 = new QuickLibraryPlus.QlibRadio();
			this.mouseWheelActionLabel = new System.Windows.Forms.Label();
			this.escToExitCheckBox = new QuickLibraryPlus.QlibCheckBox();
			this.fullscrCursorCheckBox = new QuickLibraryPlus.QlibCheckBox();
			...
			this.slideshowTimeNumeric = new QuickLibraryPlus.QlibNumeric();
			this.slideshowCounterCheckBox = new QuickLibraryPlus.QlibCheckBox();
			this.startupPage = new System.Windows.Forms.TabPage();
			this.startupBoundsCheckBox = new QuickLibraryPlus.QlibCheckBox();
			this.updatesCheckBox = new QuickLibraryPlus.QlibCheckBox();
			this.startupPasteCheckBox = new QuickLibraryPlus.QlibCheckBox();
			...
			this.browseWithCheckBox = new QuickLibraryPlus.QlibCheckBox();
			this.contextMenuLabel = new System.Windows.Forms.Label();
			this.openWithCheckBox = new QuickLibraryPlus.QlibCheckBox();
			this.browseBtn = new System.Windows.Forms.Button();
			this.favExtTextBox = new QuickLibraryPlus.QlibTextBox();
			...
			this.langComboBox = new QuickLibraryPlus.QlibComboBox();
		...
		#endregion
		private QuickLibraryPlus.QlibRadio lightThemeRadio;
		private QuickLibraryPlus.QlibRadio systemThemeRadio;
		private QuickLibraryPlus.QlibRadio darkThemeRadio;
		private System.Windows.Forms.Label restartLabel1;
		private QuickLibraryPlus.QlibCheckBox fullscrCursorCheckBox;
		private QuickLibraryPlus.QlibTabs settingsTabs;
		...
		private QuickLibraryPlus.QlibTextBox favExtTextBox;
		private System.Windows.Forms.Button browseBtn;
		private System.Windows.Forms.OpenFileDialog openFileDialog1;
		private System.Windows.Forms.TabPage slideshowPage;
		private QuickLibraryPlus.QlibCheckBox slideshowCounterCheckBox;
		private QuickLibraryPlus.QlibNumeric slideshowTimeNumeric;
		...
		private QuickLibraryPlus.QlibComboBox langComboBox;
		...
		private QuickLibraryPlus.QlibCheckBox escToExitCheckBox;
		private System.Windows.Forms.Label mouseWheelActionLabel;
		private QuickLibraryPlus.QlibRadio mouseWheelActionRadio1;
		private QuickLibraryPlus.QlibRadio mouseWheelActionRadio2;
		private QuickLibraryPlus.QlibRadio mouseWheelActionRadio3;
		private System.Windows.Forms.LinkLabel themeRestart;
		private System.Windows.Forms.LinkLabel localizationRestart;
		private QuickLibraryPlus.QlibCheckBox startupPasteCheckBox;
		private QuickLibraryPlus.QlibCheckBox updatesCheckBox;
		private QuickLibraryPlus.QlibCheckBox startupBoundsCheckBox;
		private QuickLibraryPlus.QlibCheckBox openWithCheckBox;
		private System.Windows.Forms.Label contextMenuLabel;
		private QuickLibraryPlus.QlibCheckBox browseWithCheckBox;
