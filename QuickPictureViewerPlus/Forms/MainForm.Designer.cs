namespace QuickPictureViewerPlus
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.toolStrip1 = new QuickLibraryPlus.QlibToolbar();
			this.toolStripSeparator4 = new QuickLibraryPlus.QlibToolsep();
			this.toolStripSeparator1 = new QuickLibraryPlus.QlibToolsep();
			this.zoomTextBox = new System.Windows.Forms.ToolStripTextBox();
			this.toolStripSeparator2 = new QuickLibraryPlus.QlibToolsep();
			this.toolStripSeparator3 = new QuickLibraryPlus.QlibToolsep();
			this.qlibToolsep1 = new QuickLibraryPlus.QlibToolsep();
			this.rmbMenu = new QuickLibraryPlus.QlibContextMenuStrip(this.components);
			this.qlibToolsep5 = new QuickLibraryPlus.QlibToolsep();
			this.qlibToolsep3 = new QuickLibraryPlus.QlibToolsep();
			...
			this.qlibToolsep4 = new QuickLibraryPlus.QlibToolsep();
			...
			this.toolStripSeparator7 = new QuickLibraryPlus.QlibToolsep();
			...
			this.toolStripSeparator9 = new QuickLibraryPlus.QlibToolsep();
			...
			this.qlibMenuSeparator1 = new QuickLibraryPlus.QlibToolsep();
			...
			this.qlibToolsep2 = new QuickLibraryPlus.QlibToolsep();
			this.pluginManBtn = new System.Windows.Forms.ToolStripMenuItem();
			this.toolStripSeparator10 = new QuickLibraryPlus.QlibToolsep();
	...
	"|WEBP (*.webp)|*.webp";
		...
		private QuickLibraryPlus.QlibToolbar toolStrip1;
		private QuickLibraryPlus.QlibToolsep toolStripSeparator1;
		private System.Windows.Forms.ToolStripButton zoomInButton;
		private System.Windows.Forms.ToolStripButton zoomOutButton;
		private System.Windows.Forms.ToolStripButton autoZoomButton;
		private QuickLibraryPlus.QlibToolsep toolStripSeparator2;
		...
		private QuickLibraryPlus.QlibToolsep toolStripSeparator4;
		...
		private QuickLibraryPlus.QlibToolsep toolStripSeparator7;
		private QuickLibraryPlus.QlibToolsep toolStripSeparator9;
		private QuickLibraryPlus.QlibToolsep toolStripSeparator10;
		...
		private QuickLibraryPlus.QlibToolsep qlibMenuSeparator1;
		...
		private QuickLibraryPlus.QlibToolsep toolStripSeparator3;
		...
		private QuickLibraryPlus.QlibToolsep qlibToolsep1;
		private System.Windows.Forms.ToolStripButton fullscreenBtn;
		private QuickLibraryPlus.QlibContextMenuStrip rmbMenu;
		...
		private QuickLibraryPlus.QlibToolsep qlibToolsep2;
		...
		private QuickLibraryPlus.QlibToolsep qlibToolsep3;
		...
		private QuickLibraryPlus.QlibToolsep qlibToolsep4;
